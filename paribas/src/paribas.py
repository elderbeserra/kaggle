...
class BayesianOptimization(object):
    ...
    def init(self, init_points):
        ...
        for x in self.init_points:
            ...
            if self.verbose:
                print('Initializing function at point: ', dict(zip(self.keys, x)))
...
train=pd.read_csv('/home/somar33/projetos/kaggle/kaggle/paribas/data/train.csv')
test=pd.read_csv('/home/somar33/projetos/kaggle/kaggle/paribas/data/test.csv')
random.seed(rnd)
...
rf = RFC(n_estimators=1148, min_samples_split=45.496797310616319, max_features=0.28194799974282764, n_jobs=-1, min_samples_leaf=15)
# rf = RFC(n_estimators=1500, min_samples_split=18.496797310616319, max_features=0.17456728210495764, n_jobs=-1)
rf.fit(train, target)
...
# rfcBO = BayesianOptimization(rfccv, {'n_estimators': (10, 300),
...
# rfcBO.maximize(init_points=2, restarts=50, n_iter=10)
...
submission.to_csv('bnprf_1500.csv', index=False)